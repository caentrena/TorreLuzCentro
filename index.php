    ...
    <section class="index-page page-content no-margin-top">
        <div class="slider">
            <div class="slider-container">
                ...
                <div class="slide" style="background-image: url('assets/image/foto-slider2.jpg');"></div>
                <div class="slide active" style="background-image: url('assets/image/foto-slider3.jpg');"></div>
            </div>
